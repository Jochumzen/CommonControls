...
namespace Plugghest.Modules.UserControl.DisplayPlugg.RichText
{
    public partial class Display : UserControlModuleBase
    {
        ...
        public int Order
        {
            ...
            {
                order = value;
                pnlRichText.Controls.Add(new LiteralControl(this.HtmlString));
            }
        }
        public string HtmlString
        {
            get { return this.PHText == null ? "<div><div id=Latex" + (this.Order + 1) + " class='Main'>" + "Component " + this.Order + ": " + this.RichText + " </div></div>" : "<div><div id=Latex" + (this.Order + 1) + " class='Main'> " + "Component " + this.Order + ": " + this.RichText + " " + this.PHText.Text + " </div></div>"; }
        }
